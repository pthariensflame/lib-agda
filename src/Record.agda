...
module Record {lℓ l≈ℓ} (Label-setoid : DecSetoid lℓ l≈ℓ) where

open DecSetoid Label-setoid renaming (Carrier to Label)
...
mutual
  ...
  data Signature s : Set (lℓ ⊔ suc s) where
    ∅     : Signature s
