...
module _ {a₁ a₂} {A₁ : Set a₁} {A₂ : Set a₂} where
  ...
  infixr 1 _⊎-reflexive_ _⊎-refl_ _⊎-symmetric_ _⊎-transitive_ _⊎-antisymmetric_ _⊎-asymmetric_ _⊎-≈-respects₂_ _⊎-substitutive_ _⊎-<-total_ _⊎-<-trichotomous_
  ...
  infixr 1 _⊎-isEquivalence_ _⊎-isPreorder_ _⊎-isDecEquivalence_ _⊎-isPartialOrder_ _⊎-isStrictPartialOrder_ _⊎-<-isTotalOrder_ _⊎-<-isDecTotalOrder_ _⊎-<-isStrictTotalOrder_
...
infixr 1 _⊎-setoid_ _⊎-preorder_ _⊎-decSetoid_ _⊎-poset_ _⊎-<-poset_ _⊎-<-strictPartialOrder_ _⊎-<-totalOrder_ _⊎-<-decTotalOrder_ _⊎-<-strictTotalOrder_
...
infixr 1 _⊎-⟶_ _⊎-equivalence_ _⊎-⇔_ _⊎-injection_ _⊎-↣_ _⊎-left-inverse_ _⊎-↞_ _⊎-surjection_ _⊎-↠_ _⊎-inverse_ _⊎-↔_ _⊎-cong_
