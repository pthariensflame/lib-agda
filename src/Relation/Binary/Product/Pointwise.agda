...
module _ {a₁ a₂ ℓ₁ ℓ₂} {A₁ : Set a₁} {A₂ : Set a₂} where
  ...
  infixr 2 _×-Rel_ _×-reflexive_ _×-refl_ _×-symmetric_ _×-transitive_ _×-antisymmetric_ _×-≈-respects₂_ _×-decidable_ _×-isEquivalence_ _×-isPreorder_ _×-isDecEquivalence_ _×-isPartialOrder_ _×-isStrictPartialOrder_
...
infixr 2 _×-preorder_ _×-setoid_ _×-decSetoid_ _×-poset_ _×-strictPartialOrder_
...
infixr 2 _×-⟶_ _×-equivalence_ _×-⇔_ _×-injection_ _×-↣_ _×-left-inverse_ _×-↞_ _×-surjection_ _×-↠_ _×-inverse_ _×-↔_ _×-cong_
...
at-Σ : ∀{iℓ aℓ a≈ℓ} → (I : Set iℓ) → I.Setoid I aℓ a≈ℓ → Setoid (iℓ ⊔ aℓ) (iℓ ⊔ a≈ℓ)
at-Σ I A-ixSetoid = record {
                      Carrier = Σ I A;
                      _≈_ = λ {(i₁ , a₁) (i₂ , a₂) → i₁ P.≡ i₂ × a₁ A≈ a₂};
                      isEquivalence =
                        record {
                        refl = P.refl , A-refl;
                        sym = λ {(i≡ , a≈) → P.sym i≡ ,′ A-sym a≈};
                        trans =
                          λ {(i≡ˡ , a≈ˡ) (i≡ʳ , a≈ʳ)
                               → P.trans i≡ˡ i≡ʳ ,′ A-trans a≈ˡ a≈ʳ} } }
  where open I.Setoid A-ixSetoid using () renaming ( Carrier to A ; _≈_ to _A≈_ ; refl to A-refl ; sym to A-sym ; trans to A-trans )
